...
class ApiService {
  ...
  static Future<WebtoonDetailModel> getToonById(String id) async {
    ...
    if (response.statusCode == 200) {
      ...
      var details = WebtoonDetailModel.fromJson(webtoon);
      return details;
    }
    throw Error();
  }

  static Future<List<WebtoonEpisodeModel>> getLatesetEpisodeModel(
      String id) async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var episode in episodes) {
        WebtoonEpisodeModel instance = WebtoonEpisodeModel.fromJson(episode);
